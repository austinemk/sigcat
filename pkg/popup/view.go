...
func (m PopupModel) View() tea.View {
	catStyled := lipgloss.NewStyle().Foreground(theme.PurpleColor).Render(catASCII)

	// Helper title decoration
	bannerTitle := theme.GenerateTexturedShadowTitle(theme.TruncateString(m.Task.Title, 7, false), "#AEB6FC", "#475569")
